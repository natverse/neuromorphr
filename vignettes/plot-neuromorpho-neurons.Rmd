...
```{r read.neurons, eval = TRUE}
# Read the whale neurons
whale.pyramidal.cells = neuromorpho_read_neurons(neuron_name = whale.neuron_names, batch.size = 10, nat = TRUE, progress = TRUE)

# And read the elephant neurons
elephant.pyramidal.cells = neuromorpho_read_neurons(neuron_name = elephant.neuron_names, batch.size = 10, nat = TRUE, progress = TRUE)
```
...
```{r plot.2d.neurons, fig.show='hold', fig.cap = "2D whale,elephant pyramidal neurons", eval = TRUE}
nat::nopen3d()
...
```{r plot.3d.neurons, fig.cap = "3D whale,elephant pyramidal neurons", eval = TRUE}
...
```{r mouse, fig.show='hold', fig.cap = "whale,elephant,mouse pyramidal neurons", eval = TRUE}
# Find
...
# Read
mouse.pyramidal.cells = neuromorpho_read_neurons(neuron_name = mouse.neuron_name, batch.size = 25, nat = TRUE, progress = TRUE, find = FALSE)
...
```{r metric, fig.show='hold', fig.cap = "whale,elephant,mouse metrics", eval = TRUE}
# Put names together
